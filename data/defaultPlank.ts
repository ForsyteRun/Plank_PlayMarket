...
export const defaultPlankList: IPLank[] = [
  {
    ...
    exercices: [
      ...
      { id: "3", type: "Left leg plank" as TExerciceType, time: "00:30" },
      { id: "4", type: "Right leg plank" as TExerciceType, time: "00:30" },
      { id: "5", type: "Left side plank" as TExerciceType, time: "00:30" },
      { id: "6", type: "Right side plank" as TExerciceType, time: "00:30" },
      { id: "7", type: "Elbow plank" as TExerciceType, time: "00:30" },
      { id: "8", type: "Full plank" as TExerciceType, time: "00:60" },
    ],
  },
  {
    id: "2",
